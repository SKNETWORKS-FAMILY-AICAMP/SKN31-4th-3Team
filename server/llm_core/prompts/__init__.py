    ...
    *,
    ...
    if verse_context:
        ...
        blocks.append(
            ...
            "어디에 서 있는지를 먼저 물으십시오.\n\n"
            "인물을 꺼내는 순서:\n"
            "- 첫 답변에서는 이름을 꺼내지 마십시오. 듣는 것이 먼저입니다.\n"
            "- 두 번째 답변부터는, 재료에 사람이 있다면 한 명을 실제로\n"
            "  꺼내십시오. '어떤 사람도 그랬습니다' 처럼 뭉뚱그리지 말고\n"
            "  이름과 그가 지난 자리를 말하십시오.\n"
            "- 한 번에 한 사람입니다. 재료를 다 쓰려 하지 마십시오.\n\n"
            "이름이 분명한 사람을 고르십시오. '시편 기자', '지혜를 얻은 자'\n"
            "같은 지칭보다 '여호수아', '다윗' 처럼 부를 수 있는 이름이 낫습니다.\n\n"
            "'누구도 그랬으니 당신도 괜찮다' 로 건너뛰지 마십시오. 그 사람이\n"
            "지난 자리를 먼저 말한 뒤, 사용자에게 돌아와 다시 물으십시오.\n"
            "위에 없는 사실을 지어내지 마십시오."
        )
